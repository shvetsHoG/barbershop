...
import classes from "../chooseButton/ChooseButton.module.css"
...
const Modal = ({modalVisible, choice, setChoice, exit}) => {
    ...
    const getModalMain = () =>
        <ModalBox choice={choice} setChoice={setChoice} exit={exit} modalVisible={modalVisible} text="ОНЛАЙН-ЗАПИСЬ">
            <ChooseButton text={"Выбрать специалиста"} onClick={() => setChoice("specialists")}>
            ...
            <ChooseButton text={"Выбрать дату и время"} onClick={() => setChoice("specialists")}>
            ...
            <ChooseButton text={"Выбрать услуги"} onClick={() => setChoice("services")}>
    ...
    const getModalMasters = () =>
        <ModalBox exit={exit} modalVisible={modalVisible} choice={choice}
                  setChoice={setChoice} text="Выбрать специалиста">
            {arrayServices.map(
    ...
    const getModalServices = () =>
        <ModalBox exit={exit} modalVisible={modalVisible} choice={choice}
                  setChoice={setChoice} text="Выбрать услугу">
            {arrayServices.map(
